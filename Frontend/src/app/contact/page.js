...
export default function Contact() {
  ...
  const handleSendEmail = () => {
    ...
    window.location.href = `mailto:rajendrapandey.95@live.com?subject=${emailSubject}&body=${body}`;
  };
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-lg">DeepCode-<span  className="text-lg text-red-500">Raipur, India </span></span>
              </div>
              <div className="flex space-x-6 mt-4">
                <Link
                  href="https://www.linkedin.com/in/rajendra-k-pandey"
                  target="_blank"
                ...
                <span className="text-lg">
                  linkedin.com/in/rajendra-k-pandey
                </span>
              </div>
            </motion.div>
          </div>
