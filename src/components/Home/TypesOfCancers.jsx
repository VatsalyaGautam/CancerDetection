...
export function TypesOfCancers() {
  ...
  return (
    <>
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 h-12 w-36 text-sm rounded-full font-bold bg-blue-600 hover:bg-blue-800 text-white"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
      ...
      <ul className="max-w-4xl w-full mx-auto  gap-4">
        {cards.map((card, index) => (
          ...
          >
            ...
            <motion.button
              ...
              className="px-2 w-36 h-10 py-1 text-sm rounded-full font-bold bg-blue-600 hover:bg-blue-800 text-white mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
